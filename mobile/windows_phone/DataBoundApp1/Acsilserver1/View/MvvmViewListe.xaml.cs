    ...
    public partial class MvvmView1 : PhoneApplicationPage
    {
        ...
        private void MainLongListSelector_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if ((MainLongListSelector.SelectedItem as ItemViewModel).Type == "/Assets/Icon/folder.png")
                NavigationService.Navigate(new Uri("/View/MvvmViewListe.xaml?folder=" + (MainLongListSelector.SelectedItem as ItemViewModel).ID, UriKind.Relative));
            else
                NavigationService.Navigate(new Uri("/View/MvvmViewFile.xaml?selectedItem=" + (MainLongListSelector.SelectedItem as ItemViewModel).NumFile, UriKind.Relative));
