...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Authentification_t, stringdata) + ofs \
...
const QMetaObject Authentification::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Authentification.data,
      qt_meta_data_Authentification,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Authentification::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Authentification.stringdata))
